from NTS import nts
from LPMC_model_from_Tim import lpmc_t
from LPMC import lpmc
import numpy as np
...
# ltds_model.rumb_model.plot_parameters(ltds_model.params, ltds_model.dataset_train, utility_names = {'0': 'Walking', '1': 'Cycling', '2': 'Public transport','3': 'Driving'}, save_figure=True)
...
# ltds_model.gbru_model.plot_2d('dur_driving', 'age', 2.2, 95)
# ltds_model.gbru_model.plot_2d('cost_driving_total', 'age', 18, 95)
# ltds_model.gbru_model.plot_2d('cost_transit', 'age', 15, 95)
# ltds_model.gbru_model.plot_2d('dur_pt_access', 'age', 1, 95)
# ltds_model.gbru_model.plot_2d('dur_pt_rail', 'age', 1.4, 95)
# ltds_model.gbru_model.plot_2d('dur_pt_bus', 'age', 2, 95)
# ltds_model.gbru_model.plot_2d('dur_int_waiting', 'age', 0.8, 95)
# ltds_model.gbru_model.plot_2d('dur_pt_access', 'cost_transit', 1, 15)
# ltds_model.gbru_model.plot_2d('dur_pt_rail', 'cost_transit', 1.4, 15)
# ltds_model.gbru_model.plot_2d('dur_pt_bus', 'cost_transit', 2, 15)
# ltds_model.gbru_model.plot_2d('dur_int_waiting', 'cost_transit', 0.8, 15)
# ltds_model.gbru_model.plot_2d('dur_pt_rail', 'dur_pt_bus', 1.4, 2)
# ltds_model.gbru_model.plot_2d('dur_cycling', 'distance', 3, 40000)
# ltds_model.gbru_model.plot_2d('dur_cycling', 'age', 3, 95)
# ltds_model.gbru_model.plot_2d('distance', 'age', 40000, 95)
# ltds_model.gbru_model.plot_2d('dur_walking', 'distance', 9, 40000)
# ltds_model.gbru_model.plot_2d('dur_walking', 'age', 9, 95)
# ltds_model.gbru_model.plot_2d('distance', 'age', 40000, 95)
# learning_rates = [0.1]
