...
ltds_model.bio_rum_train(valid_test=True, with_pw = False, lr = 0.1, md = 1, all_columns=False, interaction_constraints=True, monotonic_constraints=True, save_model=True)
