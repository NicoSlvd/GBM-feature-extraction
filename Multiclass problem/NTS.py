...
class nts():
    ...
    def _model(self):
        ...
        MNL_beta_params_negative = ['B_distance_Walk', 'B_distance_Bike', 'B_distance_Public_Transport', 'B_distance_Car', 'B_cars_Walk', 'B_cars_Bike', 'B_cars_Public_Transport', 'B_bicycles_Walk', 'B_bicycles_Public_Transport', 'B_bicycles_Car', 'B_precip_Walk', 'B_precip_Bike']
